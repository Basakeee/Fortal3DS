...
- `demonBossGenerator.js` — second Boss Slayer creature: a standing biped (reuses `humanGenerator.js`'s feet/legs/hip/torso/arms/neck/head layout, not a new skeleton) instead of the Ghast's floating body — red skin with a darker belly stripe and banded limbs, curved black horns, a curled arrow-tip tail, glowing orange eyes, small fangs. No dangling tentacles.

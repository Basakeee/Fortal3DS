...
- `demonBossGenerator.js` — second Boss Slayer creature: a cute cube blob, not a biped — one dominant near-cube body carries the face directly (no separate head/neck/torso), with small nub arms/legs/horns/tail stuck on rather than full-length limbs. Red skin, pink belly patch, big white-over-black eyes, a single center fang, curled black horn tips. No dangling tentacles.
